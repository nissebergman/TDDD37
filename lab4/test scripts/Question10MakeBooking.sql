...
LOCK TABLES reservation WRITE, reservation AS r1 READ, reservation AS r2 READ, 
payment WRITE, booking WRITE, ticket WRITE, year READ, flight READ, weekday READ, 
route READ, weeklyschedule READ, reservation_contact READ, passenger_reservation READ;
