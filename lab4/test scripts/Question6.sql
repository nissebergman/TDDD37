...
#SELECT "Test 12: Adding a passenger to an already payed reservation. Expected result: The booking has already been payed and no further passengers can be added" as "Message";
